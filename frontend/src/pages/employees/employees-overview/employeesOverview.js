import { CREATE_EMPLOYEE ,GET_ALL_EMPLOYEE, DELETE_EMPLOYEE, UPDATE_EMPLOYEE} from "../../../Store/actions"
...
export default {
    ...
    methods: {
      ...
      handleSubmit() {    
        ...
        this.$store.dispatch(CREATE_EMPLOYEE, formData)
        .then(()=>{
      ...
      handleUpdate(employee_id){
        ...
        console.log(this.image);
        this.$store.dispatch(UPDATE_EMPLOYEE, {'data':formData,'user':employee_id})
      },
      getEmployee(){
        this.$store.dispatch(GET_ALL_EMPLOYEE).then(
            // (data)=>{
            //     this.employee = data;
            // },
            // ()=>{
